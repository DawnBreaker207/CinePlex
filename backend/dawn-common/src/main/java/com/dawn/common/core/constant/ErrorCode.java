...
public enum ErrorCode {
    ...
    RESERVATION_PAST_SHOWTIME("Cannot reserve seats for past showtime"),
    RESERVATION_NOT_ENOUGH_SEATS("Not enough available seats. Request: {0}, Available: {1}"),
    ...
    FAILED_SEAT_LOCK("Failed to acquire seat lock, please try again"),
    SEAT_HELD_BY_ANOTHER("Seat {0} was held by another"),
    ...
    SEAT_TEMPLATE_NOT_FOUND("Seat template not found"),
    ...
    VOUCHER_ALREADY_CLAIMED("Voucher already claimed"),
    VOUCHER_MAX_PER_USER("Voucher usage limit reached"),
