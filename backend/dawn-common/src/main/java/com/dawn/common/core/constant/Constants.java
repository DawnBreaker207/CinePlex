...
public final class Constants {
    ...
    public static final String REDIS_IDEMPOTENCY_KEY = "idempotencyKey";
    ...
    public static final int HOLD_MAX_INITS = 20;
    public static final int HOLD_INIT_WINDOW_MINUTES = 10;
    public static final int REGISTER_MAX_INITS = 10;
    public static final int REGISTER_WINDOW_MINUTES = 60;
